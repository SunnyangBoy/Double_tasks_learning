...
if __name__ == '__main__':
    ...
    model.load_state_dict(torch.load('/home/ubuntu/cs/checks_recognize_v2/pths/rotate_pths/rotated_80_0.0002.pth'))
    model.to(device)
    model.eval()

    #img_label_dir = os.path.join(configs.img_rootdir, img_mode, 'Label')
    #print(img_label_dir)
    with open('./test_rotate180.txt', 'w') as writer:
        for root, dirs, files in os.walk('/home/ubuntu/cs/test_data/rotate90'):#img_label_dir):
            for file in sorted(files):
                ...
                if output[0][0] < output[0][1]:
                    ...
                    writer.write(str(width) + ',' + str(height))
                    writer.write('\n')
                img_savepath = os.path.join('/home/ubuntu/cs/test_data/rotated180', img_name)
